---
title: "Homework #0: Hello DS 6410"
...
data_dir = 'https://mdporter.github.io/DS6410/data/' # data directory
...
This document will not compile until you load the `ds6410hw-html` quarto extension. To do this, open a terminal window (if using RStudio, look for the terminal tab) and navigate to the **same directory where this file is**. Then run:
```
